...
MapAssistant.prototype.activate = function(event) {
    ...
    this.myMapView.mojo.centerUrlProvided('images/lageplan.png');
}
    ...
    if( event.type == Mojo.Event.command ) {
        switch( event.command )
        {
            case 'cmdSitePlan':
                ...
                this.spinner('off');
                break;
            case 'cmdKalkscheuneEgMap':
                this.spinner('on');
                this.myMapView.mojo.centerUrlProvided('images/lageplan_kalkscheune_eg.png');
                this.spinner('off');
                break;
            case 'cmdKalkscheuneOgMap':
                this.spinner('on');
                this.myMapView.mojo.centerUrlProvided('images/lageplan_kalkscheune_og.png');
                this.spinner('off');
                break;
        }
    }
